![Android CI](https://github.com/godot-mobile-plugins/godot-vision/actions/workflows/android-ci.yml/badge.svg)
![iOS CI](https://github.com/godot-mobile-plugins/godot-vision/actions/workflows/ios-ci.yml/badge.svg)

# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="28"> Contributing
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Project structure
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Build System Architecture
...
println(pluginConfig.pluginName)        // "VisionPlugin"
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Build Customization
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Local Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Development Workflow
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Building
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Cross-Platform Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Android Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> iOS Builds
...
- **Plugin XCFrameworks:** `ios/build/framework/VisionPlugin.debug.xcframework`, `VisionPlugin.release.xcframework`
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Code Formatting
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Testing
...
|------|----------|---------|
| `VisionTests.swift` | Swift | `Vision` class — init, `isActiveKey`, `onThisHappened` callback, ObjC bridging, concurrency |
| `VisionLoggerTests.mm` | Objective-C++ | `vision_log` global — initialization, all log levels, format string handling |

The tests are compiled into the `vision_plugin_tests` Xcode test bundle target, which declares a dependency on the main `vision_plugin` static library target. The Xcode scheme used by the build system is `vision_plugin_tests`.
...
| Concern | Detail |
|---------|--------|
| Target name | `vision_plugin_tests` |
| Product type | `com.apple.product-type.bundle.unit-test` |
| Scheme file | `ios/plugin.xcodeproj/xcshareddata/xcschemes/vision_plugin_tests.xcscheme` |
| Linked library | `libvision_plugin.a` (the main plugin target) |
| Target dependency | `vision_plugin` (built before tests run) |
| Header search paths | `$(SRCROOT)/src`, `$(CONFIGURATION_TEMP_DIR)/vision_plugin.build/DerivedSources` |

#### Writing new iOS tests

Swift tests: add a new `XCTestCase` subclass to `ios/test/unit/` and register the file in the `vision_plugin_tests` target's Sources build phase in `project.pbxproj`.

Objective-C++ tests: add a `.mm` file to `ios/test/unit/`. Import `vision_logger.h` for logger access or `vision_plugin.h` for the plugin class. Add the file to the Sources build phase the same way.

> **Note on Godot engine classes:** `VisionPlugin` (the `Object` subclass), `vision_plugin_init()`, and `vision_plugin_deinit()` all depend on `memnew`/`memdelete` and `Engine::get_singleton()`, which are Godot engine internals unavailable in a plain XCTest host. Test those paths using GDScript integration tests via the Godot editor or the [GUT](https://github.com/bitwes/Gut) framework instead.
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Creating Releases
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> GitHub Actions Workflows
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="20"> Installing to Your Project
...
# Example
./script/install.sh -t ~/MyGame -z release/VisionPlugin-Multi-v1.0.zip
```

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Troubleshooting
...
#   ios/plugin.xcodeproj/xcshareddata/xcschemes/vision_plugin_tests.xcscheme
# and the test target must be listed in the targets array of project.pbxproj.
# Verify both are present:
find ios/plugin.xcodeproj -name "vision_plugin_tests.xcscheme"
grep "vision_plugin_tests" ios/plugin.xcodeproj/project.pbxproj
```

**Problem:** iOS tests fail with "module not found" or linker errors
```bash
# The test target links against libvision_plugin.a.
...
```bash
# Tests that exercise VisionPlugin (the Godot Object subclass) or the
...
- Check existing [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-vision/discussions)
- Review [Godot documentation](https://docs.godotengine.org/)

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-vision/main/addon/src/main/icon.png" width="24"> Additional Resources
