...
// folder.
val modelDir = (project.findProperty("faceLandmarkerModelDir") as? String)
...
// reproducible builds.
val modelVersion = (project.findProperty("faceLandmarkerModelVersion") as? String)
    ?: "latest"
...
val modelUrl = "https://storage.googleapis.com/mediapipe-models/" +
